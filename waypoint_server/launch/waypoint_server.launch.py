...
def generate_launch_description():
    return LaunchDescription([
        ...
        # Group nodes under the namespace 'waypoint_manager'
        GroupAction([
            PushRosNamespace('waypoint_manager'),

            # Node: waypoint_server_node
            Node(
            ...
            # Node: waypoint_to_posestamped_node
            Node(
                package='waypoint_server',
            ...
            # Node: waypoint_visualization_node
            Node(
            ...
            # Node: radius_node (goal_event_handler)
            Node(
